...
public class FinancialTools {
    ...
    public String detectAnomalies() {
        ...
        LocalDate prevStart = start.minusDays(90);
        ...
        BigDecimal avgDailyExpense = totalExpense.divide(BigDecimal.valueOf(Math.max(dailyExpenses.size(), 1)),
        ...
        List<Map<String, Object>> prevCategories = transactionMapper.sumByCategory(userId, prevStart, start);
    ...
    public String compareWithBenchmark() {
        ...
        Map<String, Benchmark> benchmarks = loadBenchmarks();
    ...
    private Map<String, Benchmark> loadBenchmarks() {
        List<ExpenseCategory> categories = expenseCategoryMapper.selectList(null);
