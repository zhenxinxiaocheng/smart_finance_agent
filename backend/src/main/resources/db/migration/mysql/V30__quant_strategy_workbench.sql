CREATE TABLE quant_v2_object (
 ...
 payload LONGTEXT NOT NULL, created_at VARCHAR(40) NOT NULL, updated_at VARCHAR(40) NOT NULL
);
...
CREATE TABLE quant_v2_version (
 ...
 version INT NOT NULL, payload LONGTEXT NOT NULL, created_at VARCHAR(40) NOT NULL,
...
CREATE TABLE quant_v2_task (
 ...
 request_json LONGTEXT NOT NULL, result_json LONGTEXT, error_code VARCHAR(80), error_message LONGTEXT,
...
CREATE TABLE quant_v2_deployment (
 ...
 status VARCHAR(24) NOT NULL, revision INT NOT NULL, request_json LONGTEXT NOT NULL,
 result_json LONGTEXT, error_code VARCHAR(80), error_message LONGTEXT, claim_token VARCHAR(36), lease_until BIGINT,
...
CREATE TABLE quant_v2_paper_event (
 ...
 event_key VARCHAR(160) NOT NULL, kind VARCHAR(24) NOT NULL, payload LONGTEXT NOT NULL,
