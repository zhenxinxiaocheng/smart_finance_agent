CREATE TABLE quant_v2_research_snapshot (
 ...
 content_hash CHAR(64) NOT NULL, compression VARCHAR(16) NOT NULL, payload_blob LONGBLOB NOT NULL,
 metadata_json LONGTEXT NOT NULL, uncompressed_bytes BIGINT NOT NULL, compressed_bytes BIGINT NOT NULL,
...
CREATE TABLE quant_v2_experiment (
 ...
 model_ref VARCHAR(160), model_task_id VARCHAR(36), variable_definition_json LONGTEXT NOT NULL,
 baseline_values_json LONGTEXT NOT NULL, candidate_values_json LONGTEXT NOT NULL,
 base_request_json LONGTEXT NOT NULL, source_context_json LONGTEXT NOT NULL, environment_json LONGTEXT NOT NULL,
 candidate_rule_version VARCHAR(64) NOT NULL, stability_algorithm_version VARCHAR(64) NOT NULL,
 invariant_hash CHAR(64) NOT NULL, summary_json LONGTEXT, request_key VARCHAR(80), request_hash CHAR(64),
...
CREATE TABLE quant_v2_experiment_run (
 ...
 ordinal INT NOT NULL, variable_values_json LONGTEXT NOT NULL, value_hash CHAR(64) NOT NULL,
