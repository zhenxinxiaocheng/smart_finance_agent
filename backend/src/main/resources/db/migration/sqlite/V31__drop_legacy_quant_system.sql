...
DROP INDEX IF EXISTS uk_investment_active_paper_user;
DROP INDEX IF EXISTS uk_quant_paper_order_prediction;
DROP INDEX IF EXISTS uk_quant_paper_fill_order;
