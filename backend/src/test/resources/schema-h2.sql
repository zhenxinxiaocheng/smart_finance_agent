...
CREATE TABLE quant_job (
    ...
    job_type VARCHAR(30) NOT NULL, status VARCHAR(20) NOT NULL, dataset_version VARCHAR(64),
...
CREATE TABLE quant_prediction (
    ...
    top_factors_json CLOB, risk_flags_json CLOB, backtest_summary_json CLOB,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
