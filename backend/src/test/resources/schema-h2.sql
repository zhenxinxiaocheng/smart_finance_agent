...
CREATE TABLE quant_job (
    ...
    feature_set_version VARCHAR(64), model_version VARCHAR(64), strategy_version VARCHAR(80),
...
CREATE TABLE quant_strategy_version (
    ...
    product_type VARCHAR(30) NOT NULL, status VARCHAR(20) NOT NULL,
...
CREATE TABLE quant_prediction (
    ...
    as_of_date DATE NOT NULL, probability_positive_excess DECIMAL(18,10),
...
CREATE TABLE quant_training_run (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    external_job_id VARCHAR(32) NOT NULL UNIQUE, dataset_version VARCHAR(64) NOT NULL,
    feature_set_version VARCHAR(64), quant_config_version VARCHAR(80) NOT NULL,
    product_type VARCHAR(30) NOT NULL, horizon_days INT NOT NULL, status VARCHAR(20) NOT NULL,
    metrics_json CLOB, started_at TIMESTAMP NOT NULL, finished_at TIMESTAMP,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
