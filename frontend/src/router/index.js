    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'data', name: 'QuantData', component: () => import('../views/quant-workbench/MarketData.vue') },
          { path: 'data/:productId', name: 'QuantDataDetail', component: () => import('../views/quant-workbench/MarketDataDetail.vue') },
